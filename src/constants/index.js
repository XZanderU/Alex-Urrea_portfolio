...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Alexander Urrea, a creative fullstack developer, crafting immersive and intuitive web experiences.",
  description:
...
export const PROJECTS = [
  {
    ...
    description: "Responsive landing page created with Vite, React, and Tailwind CSS for fast performance and easy customization.",
    image: projects1,
...
export const CONTACT_CONTENT = {
  ...
  socialLinks: [
    ...
    {
      platform: "GitHub",
      url: "https://github.com/XZanderU",
      ariaLabel: "View my GitHub profile",
      icon: "RiGithubFill",
    },
    {
      platform: "LinkedIn",
      url: "https://www.linkedin.com/in/john-alexander-urrea-garcia-5b0219169",
      ariaLabel: "Connect with me on LinkedIn",
      icon: "RiLinkedinFill",
    },
  ],
  footerText: `© ${new Date().getFullYear()} Alexander Urrea. All rights reserved.`,
};
